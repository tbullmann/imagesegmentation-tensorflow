...
### Train
	...
	--network resnet \
	--output_dir temp/temp/standard_SNEMI3D/train \
...
### Test
	...
	--checkpoint temp/temp/standard_SNEMI3D/train \
	--output_dir temp/temp/standard_SNEMI3D/test \
	--input_dir datasets/snemi3d/input2label3/val \
    --image_width 1024  --image_height 1024

#### Evaluate
# bash tools/evaluate.sh temp/standard_SNEMI3D/test synapses
# bash tools/evaluate.sh temp/standard_SNEMI3D/test mitochondria
# bash tools/evaluate.sh temp/standard_SNEMI3D/test membranes
